  ...
  public function postDelete($comment)
  {
    ...
    public function getData()
    {
        $comments = Comment::leftjoin('posts', 'posts.id', '=', 'comments.post_id')
                        ...
                        ->select(array('comments.id as id', 'posts.id as postid','users.id as userid', 'comments.content', 'posts.slug as post_name', 'users.username as poster_name', 'comments.created_at'));
